"""
Django settings for gentle_glitter_40361 project.
...
ROOT_URLCONF = 'gentle_glitter_40361.urls'
...
WSGI_APPLICATION = 'gentle_glitter_40361.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_glitter_40361 API",
    "DESCRIPTION": "API documentation for gentle_glitter_40361 App",
    "VERSION": "v1",
}
